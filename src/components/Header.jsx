            ...
            <div className="container max-w-6xl mx-auto px-6 py-12 md:px-0">
                ...
                <nav className="flex items-center justify-between font-bold text-blue">
                    ...
                    <div className="hidden h-10 md:flex md:space-x-8">
                        ...
                        <div className="group">
                            <a className='text-blue-950' href="https://yogananda.org/lessons" target='_blank'>Events</a>
                            <div className="mx-2 group-hover:border-b group-hover:border-amber-600"></div>
                        </div>
                        <div className="group">
                            <a className='text-blue-950' href="https://yogananda.org/lessons" target='_blank'>Lessons</a>
                            <div className="mx-2 group-hover:border-b group-hover:border-amber-600"></div>
                        </div>
                        <div className="group">
                            <a className='text-blue-950' href="https://www.youtube.com/user/YoganandaSRF" target='_blank'>Listen</a>
                            <div className="mx-2 group-hover:border-b group-hover:border-amber-600"></div>
                        </div>
                        <div className="group">
                            <a className='text-blue-950' href="https://yogananda.org/self-realization-fellowship" target='_blank'>About</a>
                            <div className="mx-2 group-hover:border-b group-hover:border-amber-600"></div>
                        </div>
                ...
                {/* <!-- mobile menu --> */}
                <div id="menu" className={toggle ? "absolute top-0 bottom-0 left-0 flex flex-col self-end w-full min-h-screen py-1 pt-40 pl-12 space-y-3 text-lg text-amber-600 uppercase bg-white" : "absolute top-0 bottom-0 left-0 hidden flex-col self-end w-full min-h-screen py-1 pt-40 pl-12 space-y-3 text-lg text-amber-600 uppercase bg-white"}>
                    <a href="/Contact" className="hover:text-amber-600">Contact</a>
                    <a href="https://yogananda.org/events-and-programs" target='_blank' className="hover:text-amber-600">Events</a>
                    <a href="https://yogananda.org/lessons" target='_blank' className="hover:text-amber-600">Lessons</a>
                    <a href="https://www.youtube.com/user/YoganandaSRF" target='_blank' className="hover:text-amber-600">Listen</a>
                    <a href="https://yogananda.org/self-realization-fellowship" target='_blank' className="hover:text-amber-600">About</a>
                </div>
            </div>
        </section>
    )
